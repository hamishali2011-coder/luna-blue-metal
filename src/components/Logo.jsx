  ...
  return (
    <Link to="/" className={`inline-flex items-center gap-2.5 group ${className}`} aria-label="The Crescent Bloom home">
      <img
        ...
        className={`${dimensions} rounded-full object-cover shrink-0 shadow-soft transition-transform duration-500 group-hover:-rotate-6 ${dark ? 'ring-[3px] ring-white' : 'ring-[3px] ring-midnight-700'}`}
      />
    </Link>
  )
}
